...
\hline
Initiate                    &             In this phase we've created project vision, priorized Product Backlog adn conduct release planning \\ \hline
Analysis                    &             Functionalities (user stories, use cases),Domain model.In this phase we have made different analysises, First we have made User stories, then we have found the concept classes and made a domain model.\\ \hline
...
\begin{itemize}
	...
	\item	Main programming Language is Typscript
	\item	Own structure
...
• Database Testing. Database is one critical component of our application. Testing activies are include:\\
...
• Usability testing:\\
  - We have made usability test with a small group of students. We have made several szenarios and we have checked how smart our UI logic, and w if there are all necessary tools to use our application.\\
...
Lesson learned:\\ Learned more about writing professional documents. New tipps about system sequence diagram.
