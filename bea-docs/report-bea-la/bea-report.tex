...
I can say that I have achieved my plan, but not completely. I have created the necessary database based on system analysis and implementation. I  have made the system that works, the connection with database, connection between frontend and backend. And I have realised the features like .\\ For this document I have used material from course Software Engineering and Design \cite{sed}, Spring Applications course \cite{sf} and tutorials from \cite{spring-tut} and several tutorials from youtube.
-login\\
-registration\\
