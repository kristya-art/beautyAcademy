...
For testing  our application we have use different tests:
• JUNIT is used as the main testing tool that automates the testing process.
• Checklist to check if we have all function we need in UI.
